...
const forlder_upload_1 = require("./interceptors/forlder-upload");
...
__decorate([
    ...
    (0, common_1.UseInterceptors)((0, platform_express_1.FileInterceptor)('file'), new forlder_upload_1.FolderUploadInterceptor('./../uploads')),
